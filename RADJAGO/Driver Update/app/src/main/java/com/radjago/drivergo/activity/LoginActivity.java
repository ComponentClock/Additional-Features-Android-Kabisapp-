...
import com.radjago.drivergo.utils.NetworkUtils;
...
public class LoginActivity extends AppCompatActivity {
    ...
    TextView countryCode, sendTo, privacypolicy, textnotif, textnotif2, lupapass;
    Button buttonLogin, confirmButton, buttonDaftar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            // daftar.setTextColor(MainBG);
//            buttonLogin.setBackgroundTintList(ColorStateList.valueOf(MainBG));
        }
