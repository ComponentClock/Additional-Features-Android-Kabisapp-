...
import com.radjago.drivergo.item.BankItem;
...
public class WithdrawActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            images.setBackgroundTintList(ColorStateList.valueOf(colorCodeDark));
            submit.setBackgroundTintList(ColorStateList.valueOf(colorCodeDark));
        }
