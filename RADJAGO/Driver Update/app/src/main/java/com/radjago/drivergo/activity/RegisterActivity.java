...
import com.radjago.drivergo.models.JobModel;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cityList.add("Banjarmasin");
        cityList.add("Tanah Laut");
        cityList.add("Banjar Baru");
        cityList.add("Tabalong");
        cityList.add("Paringin");
        cityList.add("Tanjung");
        cityList.add("Martapura");
        cityList.add("Solo");
        cityList.add("Banyuwangi");
